#ifndef _TIZENNATIVESWEEPER_H_
#define _TIZENNATIVESWEEPER_H_

#include "tizenx.h"

/**
 * [TizenNativeSweeperApp] UiApp must inherit from UiApp class
 * which provides basic features necessary to define an UiApp.
 */
class TizenNativeSweeperApp
...
public:
	TizenNativeSweeperApp(void);
	virtual~TizenNativeSweeperApp(void);
